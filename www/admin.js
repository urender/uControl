...
document.addEventListener("DOMContentLoaded", function() {
	...
	var ws = new_ws(get_appropriate_ws_url("urender"), "uadmin");
	try {
	...
	document.getElementById("devices").addEventListener("click", senddevices);
	...
	document.getElementById("blink").addEventListener("click", sendleds);
	...
	function sendupgrade()
	{
		sendmsg({
			...
			params: {
				...
				'keep-controller': true
			},
			id: id++
		});
	}
	document.getElementById("upgrade").addEventListener("click", sendupgrade);
